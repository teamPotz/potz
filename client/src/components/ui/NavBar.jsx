...
const ButtonHeart = styled(NavLink)`
  background-color: ${COLOR.WHITE};
  display: flex;
  padding: 10px;
  justify-content: center;
...
const ButtonChat = styled(NavLink)`
  background-color: ${COLOR.WHITE};
  display: flex;
  padding: 10px;
  justify-content: center;
...
const ButtonMyPage = styled(NavLink)`
  margin-right: 28px;
  background-color: ${COLOR.WHITE};
  display: flex;
  padding: 10px;
...
function NavBar() {
  return (
    <NavBarWrapper>
      ...
      <ButtonChat to='/chats'>
        {({ isActive }) => (isActive ? <ClickedChatIcon /> : <ChatIcon />)}
      </ButtonChat>
      <ButtonMyPage to='/my-page'>
        {({ isActive }) => (isActive ? <ClickedMyPageIcon /> : <MyPageIcon />)}
      </ButtonMyPage>
    </NavBarWrapper>
  );
}
