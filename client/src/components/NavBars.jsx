...
const HeartIcon = () => {
    return(
        <svg width="29" height="28" viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M13.2213 25.1153C13.9983 25.6286 15.0005 25.6286 15.7763 25.1153C18.2438 23.4866 23.6163 19.5935 25.931 15.2371C28.9818 9.49014 25.399 3.7583 20.6623 3.7583C17.9626 3.7583 16.3386 5.1688 15.4403 6.38097C15.3324 6.52943 15.1909 6.65025 15.0274 6.73356C14.8638 6.81687 14.6829 6.8603 14.4994 6.8603C14.3158 6.8603 14.1349 6.81687 13.9714 6.73356C13.8079 6.65025 13.6664 6.52943 13.5585 6.38097C12.6601 5.1688 11.0361 3.7583 8.33646 3.7583C3.59979 3.7583 0.0169593 9.49014 3.06896 15.2371C5.38129 19.5935 10.7561 23.4866 13.2213 25.1153" fill="#A8A8A8"/>
        </svg>
    )
}
...
const MyPageIcon = () => {
    return(
        <svg width="29" height="28" viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M20.6762 8.50639C20.6762 11.9329 17.9288 14.6805 14.4999 14.6805C11.0721 14.6805 8.32357 11.9329 8.32357 8.50639C8.32357 5.07986 11.0721 2.3335 14.4999 2.3335C17.9288 2.3335 20.6762 5.07986 20.6762 8.50639ZM14.4998 25.6667C9.43927 25.6667 5.1665 24.8442 5.1665 21.6708C5.1665 18.4963 9.46612 17.703 14.4998 17.703C19.5616 17.703 23.8332 18.5255 23.8332 21.6988C23.8332 24.8734 19.5336 25.6667 14.4998 25.6667Z" fill="#A8A8A8"/>
        </svg>
    )
}
...
box-shadow: 0px -36px 57px 0px rgba(255, 255, 255, 0.80);
`
...
export const NavBar1 = () => {
    ...
    const HomeIconClicked = () => {
        return(
            <svg width="29" height="28" viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M11.1571 24.2357V20.6684C11.1571 19.7577 11.9007 19.0195 12.818 19.0195H16.1712C16.6117 19.0195 17.0342 19.1932 17.3457 19.5025C17.6572 19.8117 17.8322 20.2311 17.8322 20.6684V24.2357C17.8294 24.6143 17.9789 24.9784 18.2476 25.247C18.5163 25.5157 18.8819 25.6668 19.2633 25.6668H21.551C22.6194 25.6696 23.645 25.2501 24.4015 24.5011C25.158 23.7521 25.5832 22.735 25.5832 21.6743V11.5115C25.5831 10.6547 25.2006 9.84198 24.5386 9.29228L16.7562 3.12201C15.4024 2.04015 13.4628 2.07508 12.1495 3.20497L4.54468 9.29228C3.85137 9.82577 3.43698 10.6409 3.4165 11.5115V21.6639C3.4165 23.8747 5.22178 25.6668 7.44871 25.6668H9.68418C10.4763 25.6668 11.12 25.0324 11.1257 24.2461L11.1571 24.2357Z" fill="black"/>
            </svg> 
        )
    }
    ...
    return(
        <NavBarWrapper>
            <ButtonHome><HomeIconClicked></HomeIconClicked></ButtonHome>
            <ButtonHeart><HeartIcon></HeartIcon></ButtonHeart>
            <ButtonChat><ChatIcon></ChatIcon></ButtonChat>
            <ButtonMyPage><MyPageIcon></MyPageIcon></ButtonMyPage>
        </NavBarWrapper>
    )
}
...
export const NavBar2 = () => {
    ...
    const HeartIconClicked = () => {
        return(
            <svg width="29" height="28" viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M13.2213 25.1153C13.9983 25.6286 15.0005 25.6286 15.7763 25.1153C18.2438 23.4866 23.6163 19.5935 25.931 15.2371C28.9818 9.49014 25.399 3.7583 20.6623 3.7583C17.9626 3.7583 16.3386 5.1688 15.4403 6.38097C15.3324 6.52943 15.1909 6.65025 15.0274 6.73356C14.8638 6.81687 14.6829 6.8603 14.4994 6.8603C14.3158 6.8603 14.1349 6.81687 13.9714 6.73356C13.8079 6.65025 13.6664 6.52943 13.5585 6.38097C12.6601 5.1688 11.0361 3.7583 8.33646 3.7583C3.59979 3.7583 0.0169593 9.49014 3.06896 15.2371C5.38129 19.5935 10.7561 23.4866 13.2213 25.1153" fill="black"/>
            </svg> 
        )
    }
    ...
    return(
        <NavBarWrapper>
            <ButtonHome><HomeIcon></HomeIcon></ButtonHome>
            <ButtonHeart><HeartIconClicked></HeartIconClicked></ButtonHeart>
            <ButtonChat><ChatIcon></ChatIcon></ButtonChat>
            <ButtonMyPage><MyPageIcon></MyPageIcon></ButtonMyPage>
        </NavBarWrapper>
    )
...
export const NavBar3 = () => {
    ...
    return(
        <NavBarWrapper>
            <ButtonHome><HomeIcon></HomeIcon></ButtonHome>
            <ButtonHeart><HeartIcon></HeartIcon></ButtonHeart>
            <ButtonChat><ChatIconClicked></ChatIconClicked></ButtonChat>
            <ButtonMyPage><MyPageIcon></MyPageIcon></ButtonMyPage>
        </NavBarWrapper>
    )
}
...
export const NavBar4 = () => {
    ...
    const IconMyPageClicked = () => {
        return(
            <svg width="29" height="28" viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M20.6762 8.50639C20.6762 11.9329 17.9288 14.6805 14.4999 14.6805C11.0721 14.6805 8.32357 11.9329 8.32357 8.50639C8.32357 5.07986 11.0721 2.3335 14.4999 2.3335C17.9288 2.3335 20.6762 5.07986 20.6762 8.50639ZM14.4998 25.6667C9.43927 25.6667 5.1665 24.8442 5.1665 21.6708C5.1665 18.4963 9.46612 17.703 14.4998 17.703C19.5616 17.703 23.8332 18.5255 23.8332 21.6988C23.8332 24.8734 19.5336 25.6667 14.4998 25.6667Z" fill="#131313"/>
            </svg>
        )
    }
    return(
        <NavBarWrapper>
            ...
            <ButtonHeart><HeartIcon></HeartIcon></ButtonHeart>
            <ButtonChat><ChatIcon></ChatIcon></ButtonChat>
            <ButtonMyPage><IconMyPageClicked></IconMyPageClicked></ButtonMyPage>
        </NavBarWrapper>
    )
}