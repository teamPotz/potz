...
import PostsInSameCategory from './PostsInSameCategory.jsx';
import PostDetailMenu from './PostDetailMenu.jsx';
import DiscountInfoModal from '../DiscountInfoModal.jsx';
import logoImg from '../../../public/images/logo.png';
import { useAuth } from '../../contexts/AuthContext.jsx';

function PostDetail({ postDatas }) {
  ...
  return (
    <div style={backgroundStyle}>
      {showDiscountInfo && (
        <DiscountInfoModal
          setVisible={setShowDiscountInfo}
      ...
      {showMenu && (
        <PostDetailMenu
          ...
          postId={postDatas.id}
          isAuthor={user.id === postDatas.authorId}
        />
      )}
      ...
      <div style={imgContainer}>
        ...
        <div style={TopStyle}>
          ...
          <div style={{ display: 'flex' }}>
            <ButtonWrap onClick={() => setShowDiscountInfo(true)}>
              <SaleIcon />
            </ButtonWrap>
            <ButtonWrap
      ...
      {displayWidth ? <DividerProvider displayWidth={displayWidth} /> : null}
